...
<html lang="en" data-theme="null">
  ...
  <body>
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="text" placeholder="Nama Lengkap" name="nama" class="input" required="" value="<?= $data['nama']; ?>">
        <input type="text" placeholder="Asal Kota" name="kota" class="input" required="" value="<?= $data['kota']; ?>">
        <input type="text" placeholder="Asal Sekolah" name="sekolah" class="input" required="" value="<?= $data['sekolah'];  ?>">
